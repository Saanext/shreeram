...
export const mockCategories: Category[] = [
  ...
  { id: 'cat_006', name: 'Jeans', parentId: 'cat_001', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1082528/pexels-photo-1082528.jpeg' },
  { id: 'cat_007', name: 'Trousers', parentId: 'cat_001', productCount: 0, imageUrl: 'https://images.pexels.com/photos/224924/pexels-photo-224924.jpeg' },
  { id: 'cat_008', name: 'Shorts', parentId: 'cat_001', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1040945/pexels-photo-1040945.jpeg' },
  { id: 'cat_009', name: 'Jackets', parentId: 'cat_001', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1124465/pexels-photo-1124465.jpeg' },
  { id: 'cat_010', name: 'Footwear', parentId: 'cat_001', productCount: 0, imageUrl: 'https://images.pexels.com/photos/267320/pexels-photo-267320.jpeg' },
  { id: 'cat_011', name: 'Accessories', parentId: 'cat_001', productCount: 0, imageUrl: 'https://images.pexels.com/photos/3178818/pexels-photo-3178818.jpeg' },

  // Women's Subcategories
  { id: 'cat_012', name: 'Dresses', parentId: 'cat_002', productCount: 1, imageUrl: 'https://images.pexels.com/photos/985635/pexels-photo-985635.jpeg' },
  { id: 'cat_013', name: 'Tops', parentId: 'cat_002', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1598507/pexels-photo-1598507.jpeg' },
  { id: 'cat_014', name: 'Jeans', parentId: 'cat_002', productCount: 1, imageUrl: 'https://images.pexels.com/photos/932401/pexels-photo-932401.jpeg' },
  { id: 'cat_015', name: 'Skirts', parentId: 'cat_002', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1304647/pexels-photo-1304647.jpeg' },
  { id: 'cat_016', name: 'Sarees', parentId: 'cat_002', productCount: 0, imageUrl: 'https://images.pexels.com/photos/5860579/pexels-photo-5860579.jpeg' },
  { id: 'cat_017', name: 'Handbags', parentId: 'cat_002', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg' },
  { id: 'cat_018', name: 'Jewellery', parentId: 'cat_002', productCount: 0, imageUrl: 'https://images.pexels.com/photos/2735970/pexels-photo-2735970.jpeg' },
  { id: 'cat_019', name: 'Heels', parentId: 'cat_002', productCount: 0, imageUrl: 'https://images.pexels.com/photos/2927080/pexels-photo-2927080.jpeg' },

  // Kids' Subcategories
  { id: 'cat_020', name: 'T-Shirts', parentId: 'cat_003', productCount: 1, imageUrl: 'https://images.pexels.com/photos/1620760/pexels-photo-1620760.jpeg' },
  { id: 'cat_021', name: 'Outerwear', parentId: 'cat_003', productCount: 1, imageUrl: 'https://images.pexels.com/photos/5929/food-shoelaces-tab-shoes.jpg' },
  { id: 'cat_022', name: 'Dresses', parentId: 'cat_003', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1648377/pexels-photo-1648377.jpeg' },
  { id: 'cat_023', name: 'Toys', parentId: 'cat_003', productCount: 0, imageUrl: 'https://images.pexels.com/photos/3661202/pexels-photo-3661202.jpeg' },
  { id: 'cat_024', name: 'Shoes', parentId: 'cat_003', productCount: 0, imageUrl: 'https://images.pexels.com/photos/1619793/pexels-photo-1619793.jpeg' },
  { id: 'cat_025', name: 'Baby Care', parentId: 'cat_003', productCount: 0, imageUrl: 'https://images.pexels.com/photos/3957987/pexels-photo-3957987.jpeg' },
  { id: 'cat_026', name: 'School Supplies', parentId: 'cat_003', productCount: 0, imageUrl: 'https://images.pexels.com/photos/4260477/pexels-photo-4260477.jpeg' },
  { id: 'cat_027', name: 'Party Wear', parentId: 'cat_003', productCount: 0, imageUrl: 'https://images.pexels.com/photos/10313331/pexels-photo-10313331.jpeg' },
];
