...
export function WhatsAppButton() {
    ...
    return (
        <Link 
            ...
            className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 z-50 p-2 sm:p-3 bg-white rounded-full shadow-lg hover:scale-110 transition-transform duration-300"
