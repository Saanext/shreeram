...
export function AddCategoryDialog({ onCategoryAdded, categories = [] }: AddCategoryDialogProps) {
        ...
        try {
            ...
            if (imageFile) {
                ...
                if (uploadRes.ok) {
                    ...
                    // Continue without image or handle error? For now, continue but maybe warn?
                }
            }
